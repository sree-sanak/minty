...
const KNOWN_SOURCES = ['discord', 'email', 'googleContacts', 'imessage', 'linkedin', 'sms', 'telegram', 'whatsapp', 'slack'];
...
function canonicalSource(value) {
    ...
    if (key === 'imessage' || key === 'messages' || key === 'messagedm' || key === 'imessagedm' || key === 'imessagegroup') return 'imessage';
