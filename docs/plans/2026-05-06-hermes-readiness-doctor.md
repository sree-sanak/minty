...
3. **Hermes-native:** dogfood-ready plus the Minty Hermes skill is installed/discoverable. MCP config verification can come later; this plan only reports the current server/tool surface and skill install state.
